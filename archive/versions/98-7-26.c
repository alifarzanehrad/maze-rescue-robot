...
void check_error(void)  
    {   
    if (UL>50 && ULF-ULB<60  && ULF-ULB>-60 && ULF<200 && ULB<200 )
        { 
        error1=(ULF-ULB);
        error2=ULF-70;  
    ...
    else if (UR>50 && URF-URB<60  && URF-URB>-60 && URF<200 && URB<200 )
        {
    ...
    else if (ULF-ULB<60  && ULF-ULB>-60  && ULF<500 && ULF>200 && ULB<500 && ULB>200 )
        {
        error1=(ULF-ULB);
        error2=ULF-370;  
        error=error1+error2/2;
    ...
    else if (URF-URB<60  && URF-URB>-60  && URF<500 && URF>200 && URB<500 && URB>200 )
        {
        error1=(URB-URF);    // chap & rast bar aks ham hastand
        error2=370-URF;  
        error=error1+error2/2;
...
void  menu_sensor(void)
    ...
    ///////////////
        ...
        if(page==2)    // ultra
            ...
            sprintf(text,"adc4=%4d  adc5=%4d   ",adc4,adc5);
            lcd_gotoxy(0,2);
            lcd_puts(text);  
            ...
            {
            sprintf(text,"ekhtelaf=%4d    ",adc4-adc5);
            lcd_gotoxy(0,0);
            lcd_puts(text);
            delay_ms(50);
            }
...
void main(void)
    ...
    while(1)
    {
      ...
      calculate();
      M=0;
        if((adc5<200 && adc5<200) || memR>9)     M+=1;
