...
void check_error(void)  
    {   
    if (UL>50 && abs(ULF-ULB<60) && ULF<200 && ULB<200 )
        { 
        error1=(ULF-ULB);
        error2=ULF-70;  
        error=error1+error2/10; 
        
        lcd_gotoxy(0,2);
        lcd_puts("  left near  ");
        }
    else if (UR>50 && abs(URF-URB)<360 && URF>50 && URB>50 )
        {
    ...
    else if (abs(ULF-ULB<60) && ULF<500 && ULF>200 && ULB<500 && ULB>200 )
        {
        error1=(ULF-ULB);
        error2=ULF-370;  
        error=error1+error2/10;
    ...
    else if (abs(URF-URB<360) && URF>50 && URB>50 )
        {
        error1=(URB-URF);    // chap & rast bar aks ham hastand
        error2=300-URF;  
        error=error1+error2/10;
